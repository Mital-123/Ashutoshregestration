...
function ViewPatientDetails() {
    ...
    useEffect(() => {
        axios.get("http://localhost:9090/edit/" + dataId)
    ...
    // Get Payment Data
    const getdata = () => {
        axios.get("http://localhost:9090/patient_payment/Patient_id=" + dataId).then(function (response) {
    ...
    const handleSave = () => {
        ...
        if (!newRow._id) {
            ...
            delete newRow.id;
            axios.post('http://localhost:9090/patient_payment', { Patient_id: dataId, data: [newRow] })
                .then(function (response) {
                    getdata();
                })
                .catch(function (error) {
            ...
            axios.put("http://localhost:9090/payment-update/" + newRow._id, newRow)
                .then(function (response) {
                    getdata();
    ...
    const DeviceName = () => {
        //Devices_Data
        axios.get('http://localhost:9090/devices')
            .then((response) => {
    ...
    const DiognoseName = () => {
        //Diagnosis_Data
        axios.get('http://localhost:9090/diagnosis')
            .then(function (response) {
                                    ...
                                    <Table responsive className='bg text-center '>
                                        ...
                                        <tbody>
                                            ...
                                            {adding && (
                                                <tr>
                                                    <td>
                                                        <TextField type="date" className='display-4' value={newRow.date ? newRow.date.substring(0, 10) : ''} onChange={(e) => handleChange(e, 'date')} />
                                                    </td>
